...
public class GetCommentsTest extends TicketTest {
	...
	public void testGetMovieComments() {
		...
		Assert.assertEquals("Comments list size does not match expected", expectedSize, commentDocs.size());

		String expectedName = "Arya Stark";
		Assert.assertEquals("Expected `name` field does match: check your " + "getMovie() comments sort order.",
				expectedName, commentDocs.get(1).getString("name"));
	}
	...
	public void testCommentsMovieIdNonExisting() {
		...
		Assert.assertNull("Non-existing movieId should return null document. " + "Check your getMovie() method",
